...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // For ball
        heldBall = transform.FindChild("Ball");

        // For portals
        portalGun = m_Camera.transform.FindChild("PortalGun");
    }
    ...
    private void FixedUpdate()
    {
        ...
        if (throwing && heldBall != null) {
            ...
            //if (Physics.Raycast(m_Camera.transform.position, m_Camera.transform.forward, out hit, 50f)) {
            ...
            ballRB.AddForce((m_Camera.transform.forward * 1000) - m_Camera.transform.position);
            heldBall = null;
        }
    ...
    void OnTriggerEnter (Collider col) {
        if (col.transform.tag == "Ball") {
            ...
            if (heldBall == null && col.transform.parent == null && ballRB.velocity.magnitude < 5f) {
                ...
                heldBall.parent = this.transform;
                ballRB.isKinematic = true;
                heldBall.transform.localPosition = new Vector3(0.4f, 0, 1);
            }
        }
    }
}
